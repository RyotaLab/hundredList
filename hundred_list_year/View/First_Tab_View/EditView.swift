...
struct EditView: View {
    ...
    init(bucket_item:BucketList){
        ...
        _isImportant = State.init(initialValue: bucket_item.important)
    }
                ...
                ZStack{
                    ...
                    VStack(spacing:30){
                        ...
                        TextField("名前を入力してください", text: $name_field)
                            .focused($focusedField, equals: .edit_name)
                            .overlay(
                        ...
                        HStack{
                            Text(isImportant ? "高い" : "普通")
                                ...
                                .foregroundColor(isImportant ? .green : .primary)
                        ...
                        Button{
                            if name_field == ""{
                                ...
                                //編集処理
                                realmController.UpdateList(bucketItem: bucket_item, bucket_name: name_field, bucket_tag: selectedTag, bucket_important: isImportant)
